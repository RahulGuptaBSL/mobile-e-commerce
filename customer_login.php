...
<div>
	<form method="post" action="">
		...
		<table width="500" align="center" bgcolor="skyblue">
			...
			<tr align="center">
			<td colspan="4"><input type="submit" name="login" value="Login"/></td></tr>
			<tr align="center">
			<td colspan="3"><a href="checkout.php?forgot_pass">Forgot Passward?</a></td>
			</tr>
	...
	if(isset($_POST['login'])){
		...
		if($check_customer==0){
			...
			if($check_customer>0 AND $check_cart==0){
				...
				echo"<script>alert('You login successfully,Tnks!')</script>";
